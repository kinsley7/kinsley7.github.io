        ...
        <Column classNames='my-auto'>
          {items.map((item, index) => 
            <Card key={index} onClick={() =>
				...
				classNames={`bg-[var(--dark-card-color)]/2 z-0 rounded-[13px] p-2 my-2 shadow-lg max-w-sm transition-all scale-90 ease-in-out hover:-translate-y-1 hover:scale-100 ${index === activeIndex ? '': 'w-[150px]'}`}>
            	<Column>
