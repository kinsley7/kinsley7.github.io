...
export const AboutMe = ({togglePopup} : AboutMeProps) => {
	...
	return(
		<section id='about me' className="">
			...
			I want to grow as a professional in the technology field, always learning and using my skills to help others. I want to make a positive impact through collaboration and sharing knowledge.			<br/>
			<h2>Career Goals</h2>
